 ...
 *     default_locale?: scalar|Param|null, // The default locale for the application, used as a fallback when no fallbacks are defined. // Default: null
 *     enabled_locales?: list<scalar|Param|null>,
 ...
 *     detect_request_locale?: bool|Param, // If "true", "AlexandreFernandez\JsonTranslationBundle\Model\JsonTranslation" class instances will default to the current request's locale, else they will default to "default_locale". // Default: true
 * }
 * @psalm-type SurvosGeoapifyConfig = array{
 *     api_key?: scalar|Param|null, // Default: "%env(GEOAPIFY_API_KEY)%"
 * }
 ...
 *     secret?: scalar|Param|null, // Default: ""
 *     cache_expiration?: scalar|Param|null, // Default: 3600
 * }
