 ...
 * }
 * @psalm-type KeyValueFormConfig = array<mixed>
 * @psalm-type JsonTranslationConfig = array{
 *     default_locale?: scalar|null, // The default locale for the application, used as a fallback when no fallbacks are defined. // Default: null
 *     enabled_locales?: list<scalar|null>,
 *     fallbacks?: mixed, // Which locale will the application fallback on when the current locale is not found, an empty array will disable fallbacks. // Default: null
 *     detect_request_locale?: bool, // If "true", "AlexandreFernandez\JsonTranslationBundle\Model\JsonTranslation" class instances will default to the current request's locale, else they will default to "default_locale". // Default: true
 * }
 * @psalm-type SurvosGeoapifyConfig = array{
 *     api_key?: scalar|null, // Default: "%env(GEOAPIFY_API_KEY)%"
 * }
 ...
 *     ux_map?: UxMapConfig,
 *     key_value_form?: KeyValueFormConfig,
 *     json_translation?: JsonTranslationConfig,
